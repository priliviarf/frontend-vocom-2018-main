...
<head>
  ...
  <title>Admin Dashboard | Upload</title>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            <p>Anda yakin ingin <strong>menghapus</strong> data?</p>
    ...
    <div class="row content">
      ...
      <div class="col-lg-2 col-md-3 col-sm-12 sidenav">
        ...
        <ul id="nav" class="text-left">
          ...
          <li>
            <a href="./upload.html" class="active col-sm-12">
          ...
          <div class="row">
            <div class="col-md-12">
              <section class="bigbox pd-20">
                  <h4 class="text-left title-event-db">Upload</h4>
                  <!-- table -->
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>lorem.zip</td>
                          <td class="py-1">
                            <a href="" class="btn-primary btn-sm"><i class="fa fa-download"></i></a>
